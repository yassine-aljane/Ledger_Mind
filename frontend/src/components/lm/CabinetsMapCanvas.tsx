/**
 * Rendu Leaflet de la carte des cabinets — VOLONTAIREMENT isolé dans son propre module.
 *
 * `leaflet` lit `window` dès l'évaluation du module (leaflet-src.js), pas seulement au
 * montage : sous TanStack Start, un simple `import` en tête de composant suffit donc à
 * faire échouer le rendu serveur, même si le composant ne s'affiche qu'après montage.
 * Tout ce qui touche à Leaflet vit ici, et `CabinetsMap` ne charge ce fichier qu'en
...
/** Export par défaut : requis par le `lazy()` de CabinetsMap. */
export default function CabinetsMapCanvas({
  cabinets,
  center = null,
  selectedId = null,
  onSelect,
