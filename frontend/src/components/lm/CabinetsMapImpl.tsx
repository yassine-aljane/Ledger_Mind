/**
 * Carte OpenStreetMap des cabinets — IMPLÉMENTATION Leaflet.
 *
 * ⚠️  Ne jamais importer ce module directement depuis un écran : Leaflet lit `window`
 * dès son chargement, ce qui fait échouer le rendu serveur. Passer par
 * `CabinetsMap`, qui ne le charge qu'une fois dans le navigateur.
 *
 * Tuiles OSM (gratuites, sans clé). Marqueurs « calculatrice » plutôt que le pin
 * rouge par défaut.
 */
...
export default function CabinetsMapImpl({
  cabinets,
  center = null,
  selectedId = null,
  onSelect,
