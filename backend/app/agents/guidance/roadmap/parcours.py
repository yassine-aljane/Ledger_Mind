...
existant (`from app.agents.guidance.roadmap import parcours`, `from app.agents.guidance.roadmap.parcours import build_roadmap`).
Les nouveaux appelants peuvent importer directement les modules ci-dessus.
"""
from __future__ import annotations

from app.agents.guidance.roadmap.analyse_juridique import (  # noqa: F401
    DURABILITE_DURABLE,
    DURABILITE_INDET,
    DURABILITE_PONCTUEL,
    DURABILITE_STABLE,
...
from app.agents.guidance.roadmap.presentation import (  # noqa: F401
    BANDE_BASCULE_BAS,
    BANDE_BASCULE_HAUT,
    PARCOURS_BASCULE,
    PARCOURS_MICRO,
