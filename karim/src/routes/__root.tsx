...
import { AuthProvider, EntitlementsProvider } from "../lib/auth";

function NotFoundComponent() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <p className="rule-label text-accent-foreground">Erreur 404</p>
        <h1 className="mt-3 text-4xl">Cette page n'existe pas</h1>
        <p className="mt-3 text-sm text-muted-foreground">
          Le lien est peut-être obsolète. Revenez à l'accueil pour reprendre votre parcours.
        </p>
        <Link
          to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LedgerMind — Copilote fiscal des indépendants" },
      {
        name: "description",
        content:
          "LedgerMind guide les indépendants et créateurs : réponses fiscales sourcées, parcours d'immatriculation, capture de factures et mise en relation avec des cabinets.",
      },
      { property: "og:title", content: "LedgerMind — Copilote fiscal des indépendants" },
      {
        property: "og:description",
        content: "Comprenez, décidez, agissez : votre fiscalité française pilotée de bout en bout.",
      },
